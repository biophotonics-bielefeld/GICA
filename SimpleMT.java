...
public final class SimpleMT {
    ...
    static {
	Tools.log("(multi-core) init to "+nrThreads+" threads ",Tools.LL.DEBUG);
    }
	...
	Tools.log("parallel mode switched "+((value)?("ON"):("OFF")), Tools.LL.INFO);
	doParallel = value;
    }
	...
	for (int loop=0;loop<10;loop++) {
	    ...
	    System.out.println("   PFor: "+t2);
	    System.out.println("StrPFor: "+t3);
	    System.out.println("---");
